...
if __name__ == "__main__":
    ...
    train_data = get_iterator(path='DATA_rec/cat_train_xiao.rec', data_shape=(3, 224, 224), label_width=7 * 7 * 5, batch_size=32,
                              shuffle=True)
    val_data = get_iterator(path='DATA_rec/cat_val_xiao.rec', data_shape=(3, 224, 224), label_width=7 * 7 * 5, batch_size=32)
    ...
    # save model
    checkpoint = mx.callback.do_checkpoint('models/cat_xiao_train',period = 50)
